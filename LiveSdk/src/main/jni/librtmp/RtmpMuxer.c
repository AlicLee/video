...
#include "rtmp_flvmuxer.h"

/**
 * if it returns bigger than 0 it is successfull
 */
JNIEXPORT jint JNICALL
Java_net_butterflytv_rtmp_1client_RTMPMuxer_open(JNIEnv *env, jobject instance, jstring url_, jint video_width, jint video_height,jobject callback) {
