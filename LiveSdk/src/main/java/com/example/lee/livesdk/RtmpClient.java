...
public class RtmpClient {
     ...
     * @throws IOException if connection is not opened or connection to server is lost
     */
    public int write(byte[] data,int size) throws IOException {
        return nativeWrite(data,size, rtmpPointer);
    }

    private native int nativeWrite(byte[] data,int size, long rtmpPointer) throws IOException;
