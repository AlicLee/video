...
package com.example.lee.opengles;
...
import com.example.lee.livesdk.R;
...
public class GPUImageFilter {
    ...
    private final int mVertexShaderId;//定点着色器id
    private final int mFragmentShaderId;//片元着色器id
    ...
    public GPUImageFilter() {
        this(R.raw.vertex, R.raw.fragment);
    }

    public GPUImageFilter(int fragmentShaderId) {
        this(R.raw.vertex, fragmentShaderId);
    }
