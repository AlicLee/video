...
public class LinearProgressView extends View {
    ...
    private void getAtt(AttributeSet attrs) {
        TypedArray typedArray = mcontext.obtainStyledAttributes(attrs, R.styleable.LinearProgressView);
        paintColor = typedArray.getColor(R.styleable.LinearProgressView_lp_paintColor, mcontext.getResources().getColor(R.color.colorPrimary));
        paintWidth = typedArray.getDimension(R.styleable.LinearProgressView_lp_paintWidth, dp2px(10));
        bgPaintSize = typedArray.getDimension(R.styleable.LinearProgressView_lp_bgPaintSize, dp2px(10));
        textSize = typedArray.getDimension(R.styleable.LinearProgressView_lp_textSize, 30f);
        type = typedArray.getInt(R.styleable.LinearProgressView_lp_type, 1);
        mStartColor = typedArray.getColor(R.styleable.LinearProgressView_lp_startColor, mcontext.getResources().getColor(R.color.colorAccent));
        mEndColor = typedArray.getColor(R.styleable.LinearProgressView_lp_endColor, mcontext.getResources().getColor(R.color.colorPrimaryDark));
    ...
    private void initPaint() {
        paint = getPaint(Paint.Style.FILL, mcontext.getResources().getColor(R.color.white), bgPaintSize / 2);
        ...
        recPaint = getPaint(Paint.Style.FILL, mcontext.getResources().getColor(R.color.colorPrimary), 3);
        recPaint1 = getPaint(Paint.Style.STROKE, mcontext.getResources().getColor(R.color.white), 1);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (linearGradient == null) {
            linearGradient = new LinearGradient(0, h, w, h, mColorArray, null, Shader.TileMode.CLAMP);
        }
    }
